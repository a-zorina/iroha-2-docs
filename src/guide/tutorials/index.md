...
0. If you are already familiar with Hyperledger Iroha, read about
   [the differences](/get-started/iroha-2) between the two versions of Iroha.
1. [Install Iroha 2](/get-started/install-iroha).
2. Follow one of the language-specific guides to learn how to set up and
   ...
   - [Python](/guide/tutorials/python)
   - [Rust](/guide/tutorials/rust)
   - [Kotlin/Java](/guide/tutorials/kotlin-java)
   - [Javascript (TypeScript)](/guide/tutorials/javascript)

...
Ensure you [brought up the test network](/get-started/launch-iroha). You can monitor blockchain events in the terminal where it runs.
...
In order to mint assets, you need to register the [asset definition](/blockchain/assets) first. We are going to register the _tea_ token within the _looking_glass_ network. To do that, run:
...
Now that you know the basics, you can proceed to one of our language-specific [turorials](/guide/tutorials/) to learn how to build on Iroha.
...
[dedicated chapter](/blockchain/permissions).
...
- **Details**: Returns the value keyed by the provided `Name` for the given
  ...
  This is done by querying the [`metadata`](/blockchain/metadata)
...
- **Details**: Gets the value keyed by the given name in the
  [metadata](/blockchain/metadata) of the asset corresponding to
...
- **Details**: Gets the value keyed by the given name in the
  [metadata](/blockchain/metadata) of the asset definition
...
- **Details**: Finds the value corresponding to the key in the
  [metadata](/blockchain/metadata) of the trigger with the given
  ID.
